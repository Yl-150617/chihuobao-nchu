...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
       <%-- <dl id="menu-member">
        ...
        <dl id="menu-comments">
            <dt><%--<i class="Hui-iconfont">&#xe622;</i> --%>商品评论<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
       ...
       <%-- <dl id="menu-admin">
        ...
        <c:if test="${subject.hasRole('admin')}">
            <dl id="menu-system">
                <dt><%--<i class="Hui-iconfont">&#xe62e;</i>--%> 美食圈管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
                <dd>
                    <ul>
                        <li><a href="/zixun/list" title="资讯列表">美食圈评论</a></li>
                    </ul>
                </dd>
            </dl>
        </c:if>
