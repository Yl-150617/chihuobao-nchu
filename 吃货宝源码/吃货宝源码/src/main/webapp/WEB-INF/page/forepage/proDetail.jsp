              ...
              <%--      <div class="rating d-inline-block mb-15">
                   ...
                   <%-- <p class="d-inline-block ml-10 review-link">
                    ...
                    <h2 class="product-price mb-0">
                        ...
                        <span class="discounted-price"> 售价：${product.price}</span>
                    </h2>
                    ...
                    <div class="fl-product">
                       ...
                       &lt;%&ndash;     <div class="rating">
                            ...
                            <p class="product-price">
                               &lt;%&ndash; <span class="main-price discounted">￥${pf.price+15.1}</span>&ndash;%&gt;
                                <span class="discounted-price">售价：${pf.price}</span>
                            </p>
                        </div>
                    </div>
                    </c:forEach>
