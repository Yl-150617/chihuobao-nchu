                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${ois}" var="orderItem">
                                <tr>
                                    ...
                                    <c:if test="${cst.status==0}"><td class="pro-price"><span>售价：${orderItem.product.price}</span></td></c:if>
                                    <c:if test="${cst.status==1}"><td class="pro-price"><span>售价：${orderItem.product.price}</span></td></c:if>
                                    <td class="pro-quantity"><%--<div class="pro-qty">--%><span>${orderItem.number}</span><%--</div>--%></td><%--王菀轩--%>
                                    <c:if test="${cst.status==0}">
                                        <td class="pro-subtotal"><span id="xiaoji1">售价：${orderItem.number*orderItem.product.price}</span></td>
                                    </c:if>
                                    <c:if test="${cst.status==1}">
                                        <td class="pro-subtotal"><span id="xiaoji08">售价：${orderItem.number*0.8*orderItem.product.price}</span></td>
                                    </c:if>
                                </tr>
                            </c:forEach>
                            </tbody>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-60">
                                                    ...
                                                    <div class="checkout-cart-total">
                                                        ...
                                                        <p>小计 <span>售价：${total}</span></p>

                                                        <p>运费 <span>售价：10</span></p>

                                                        <h4>总计 <span>售价：${total+10.0}</span></h4>
