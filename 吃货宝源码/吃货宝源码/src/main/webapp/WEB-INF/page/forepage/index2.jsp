                                        ...
                                        <p class="product-price">
                                         <%--   <span class="main-price discounted">
                                            ...
                                            <span class="discounted-price">
                                                售价：<fmt:formatNumber type="number" value="${product.price}" pattern="0.00" maxFractionDigits="2"/>
                                            </span>
                                        </p>
                    ...
                    <div class="col-lg-7 col-md-6 col-xs-12">
                        ...
                        <div class="product-feature-details">
                            ...
                            <h2 class="product-price mb-15">
                                ...
                                <span class="discounted-price" id="proPrice">售价：</span>
                            </h2>
...
<script type="text/javascript">
    ...
    function Values(id,name,price,imageUrl,miaoshu) {
        ...
        $("#proPrice").html('售价：'+price);
        var proPrice1 = price +15;
        $("#proPrice1").html('售价：'+proPrice1);
