...
<head>
    ...
    <style type="text/css">
        *{padding:0px;margin:0px;}
        ...
        img{border:0;}
        .lg{width:600px;height:600px;margin:120px auto;/*background:url(../../images/slide/slide01.jpg)*/ no-repeat;}
        .lg_top{font-size: 100px;}
        ...
        .bn{background-color:salmon;width:330px;height:72px;/*background:url(../../images/enter.png) no-repeat;*/border:0;display:block;font-size:18px;color: #49d4ae;font-family:Arial, Helvetica, sans-serif;font-weight:bolder;cursor:pointer;}
