...
<div class="header-container header-container-home-4 header-sticky white-bg">
    ...
    <div class="navigation-menu-top navigation-menu-top-home-4 pt-35 pb-35 pt-md-15 pb-md-15 pt-sm-15 pb-sm-15 mb-md-55 mb-sm-55">
        <div class="container">
            <div class="row align-items-center margin-top-bottom">
                <div class="col-6 col-lg-2 col-md-6 col-sm-6 order-1 order-lg-1">
                    <!--=======  logo  =======-->

                    <div class="logo">
                        <a href="/fore/foreIndex">
                            <img src="${pageContext.request.contextPath}/assets/images/logo.jpg" class="img-fluid" alt="">
                        </a>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-7">
                    ...
                    <div class="main-menu">
                        <nav>
                            <ul>
                                <li class="active menu-item-has-children"><a href="#">品牌分类</a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="/fore/foreZixuns">商圈</a></li>
                ...
                <div class="col-12 col-lg-3">
                    ...
                    <div class="navigation-search d-none d-lg-block">
                        <form method="post" action="/fore/foreNameLike">
                            <input type="search" placeholder="搜索产品" name="pName">
